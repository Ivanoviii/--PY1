...
def to_csv_file(filename, headers, data_array, delimiter=',', new_line='\n'):
    headers_st = delimiter.join(headers)
    with open(filename, 'w') as file:
        file.write(headers_st + new_line)
        for line in data_array:
            file.write(delimiter.join(line) + new_line)
